...
public class KatalogAdapter extends BaseAdapter {
    ...
    ArrayList<KatalogClass> coinClasses = new ArrayList<>();
    Activity activity;
    LayoutInflater layoutInflater;
    GenelKutuphane generalLibrary;

    public KatalogAdapter(ArrayList<KatalogClass> coinClasses, Activity activity) {
    ...
    @Override
    public KatalogClass getItem(int i) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        coin_vol.setText("" + getItem(i).getAd());
